        ...
        children: [
          ...
          Expanded(
            child: Text(
              _applied
                  ? strings.text(
                      GenUiStringKey.appliedAccent,
                      'Accent tuned for this chat',
                    )
                  : strings.text(
                      GenUiStringKey.suggestedAccent,
                      'Suggested accent for this chat',
                    ),
              style: Theme.of(
                context,
          ...
          if (_applied)
            ...
            GenUi.pill(
              context,
              strings.text(GenUiStringKey.apply, 'Apply'),
              () {
...
class ShortcutsDirectiveRenderer extends StatefulWidget {
  const ShortcutsDirectiveRenderer({
    super.key,
    required this.spec,
    required this.actions,
  });
...
class _ShortcutsDirectiveRendererState
    extends State<ShortcutsDirectiveRenderer> {
  ...
  Widget build(BuildContext context) {
    ...
    final strings = GenUiLocalizations.of(context);
    final canSave =
        widget.actions.setShortcuts != null &&
        widget.actions.enabled &&
        !_saved;
    return GenUi.frame(
      context,
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  _saved
                      ? strings.text(
                          GenUiStringKey.savedShortcuts,
                          'Saved to your shortcuts',
                        )
                      : strings.text(
                          GenUiStringKey.suggestedShortcuts,
                          'Suggested shortcuts',
                        ),
                  style: Theme.of(
                    context,
              ...
              if (_saved)
                ...
                GenUi.pill(
                  context,
                  strings.text(GenUiStringKey.save, 'Save'),
                  () {
